...
![](./Figures/task_timeline.png)

The Task Timeline outlines three phases that occur through time. The tiem required will depend on the availability of data, the number of people working on the assessment, as well as challenges that may arise. Tasks are indicated by skill set but many decisions will also occur as a team.
